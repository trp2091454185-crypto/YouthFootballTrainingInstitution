...
func (c *uploadClient) UploadFile(ctx context.Context, in *UploadReq, opts ...grpc.CallOption) (*UploadResp, error) {
...
func (UnimplementedUploadServer) UploadFile(context.Context, *UploadReq) (*UploadResp, error) {
...
func _Upload_UploadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UploadServer).UploadFile(ctx, req.(*UploadReq))
	}
