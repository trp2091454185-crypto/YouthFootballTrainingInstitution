...
type InstitutionFacility struct {
	...
	Images      *string   `json:"images,optional" form:"images,optional" gorm:"column:images;default:'{}'"`       // 设施图片数组
	Features    *string   `json:"features,optional" form:"features,optional" gorm:"column:features"`              // 设施特点标签数组
