...
type Coach struct {
	...
	CareerHistory    *string    `json:"careerHistory,optional" form:"careerHistory,optional" gorm:"column:career_history"`            // 执教履历
	Certificates     *string    `json:"certificates,optional" form:"certificates,optional" gorm:"column:certificates"`                // 资质证书
	Specialties      *string    `json:"specialties,optional" form:"specialties,optional" gorm:"column:specialties"`                   // 专项擅长:启蒙/体能/战术/门将等
	AgeGroups        *string    `json:"ageGroups,optional" form:"ageGroups,optional" gorm:"column:age_groups"`                        // 适合年龄段:U6/U8/U10/U12等
