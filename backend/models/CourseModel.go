...
type Course struct {
	...
	CategoryId     int64     `json:"categoryId,optional" form:"categoryId,optional" gorm:"column:category_id;not null"`                  // 分类ID
	...
	SuitableAgeMin *int32    `json:"suitableAgeMin,optional" form:"suitableAgeMin,optional" gorm:"column:suitable_age_min;default:6"`    // 适合最小年龄
	SuitableAgeMax *int32    `json:"suitableAgeMax,optional" form:"suitableAgeMax,optional" gorm:"column:suitable_age_max;default:16"`   // 适合最大年龄
	...
	ClassDuration  *int32    `json:"classDuration,optional" form:"classDuration,optional" gorm:"column:class_duration;default:90"`     // 单次课时(分钟)
	ClassSizeMin   *int32    `json:"classSizeMin,optional" form:"classSizeMin,optional" gorm:"column:class_size_min;default:1"`        // 最少开班人数
	ClassSizeMax   *int32    `json:"classSizeMax,optional" form:"classSizeMax,optional" gorm:"column:class_size_max;default:20"`       // 最多容纳人数
	...
	Outline        *string   `json:"outline,optional" form:"outline,optional" gorm:"column:outline"`                                   // 课程大纲
	Objectives     *string   `json:"objectives,optional" form:"objectives,optional" gorm:"column:objectives"`                          // 教学目标
	Features       *string   `json:"features,optional" form:"features,optional" gorm:"column:features"`                                // 课程特色
