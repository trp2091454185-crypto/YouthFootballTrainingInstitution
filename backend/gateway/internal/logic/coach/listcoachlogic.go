...
type (
	...
	ListLibResp struct {
		result.PageResult
		List []models.Coach `json:"list"`
	}
)
type ListCoachLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewListCoachLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListCoachLogic {
	return &ListCoachLogic{
...
func (l *ListCoachLogic) ListCoach(req *ListCoachReq) (*ListLibResp, error) {
