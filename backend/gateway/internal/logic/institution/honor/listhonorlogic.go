...
type (
	ListHonorReq struct {
		models.InstitutionHonor
		result.PageParams
	}

	ListLibResp struct {
		result.PageResult
		List []models.InstitutionHonor `json:"list"`
	}
)
type ListHonorLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewListHonorLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListHonorLogic {
	return &ListHonorLogic{
...
func (l *ListHonorLogic) ListHonor(req *ListHonorReq) (*ListLibResp, error) {
	...
	// 查询列表
	var list []models.InstitutionHonor
